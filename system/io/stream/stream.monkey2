...
#end
Class Stream Extends stdlib.system.resource.Resource
	...
	Method Skip:Int( count:Int )
		...
		Local tmp:=stdlib.plugins.libc.malloc( 4096 ),n:=0
	...
	| Stream path prefix	| Supported platforms   | Description
	|:----------------------|:----------------------|:-----------
