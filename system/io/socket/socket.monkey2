...
#rem monkeydoc @hidden
#end
Function socket_sockaddrname:Int( addr:Void Ptr,addrlen:Int,host:stdlib.plugins.libc.char_t Ptr,service:stdlib.plugins.libc.char_t Ptr )="bbSocket::sockaddrname"
...
Class SocketAddress
	...
	Operator<=>:Int( address:SocketAddress )
		Local n:=stdlib.plugins.libc.memcmp( _addr.Data,address._addr.Data,Min( _addrlen,address._addrlen ) )
	...
	Method Validate()
		...
		Local host:=New stdlib.plugins.libc.char_t[1024]
		Local service:=New stdlib.plugins.libc.char_t[80]
...
#end
Class Socket Extends stdlib.system.resource.Resource
