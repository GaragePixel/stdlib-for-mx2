...
Class StbAudioData Extends AudioData
	...
	Method OnDiscard() Override
		...
		stdlib.plugins.libc.free( _data )
...
Function LoadAudioData_OGG:AudioData( path:String )
	...
	Local buf:=stdlib.system.memory.DataBuffer.Load( path )
	...
	Local length:=stdlib.plugins.stb.vorbis.stb_vorbis_decode_memory( buf.Data,buf.Length,Varptr channels,Varptr hertz,Varptr samples )
	...
	Default
		stdlib.plugins.libc.free( samples )
		Return Null
	End
