...
Function ReadWAV:AudioData( stream:stdlib.system.io.Stream )

	Local wav:=New WAV_Header
	Local wav_sz:=stdlib.plugins.libc.sizeof( wav )
	...
	While Not stream.Eof
		...
		Case $20746d66		'FMT
			...
			Local fmt_sz:=stdlib.plugins.libc.sizeof( fmt )
...
Function LoadAudioData_WAV:AudioData( path:String )
	...
	Local stream:=stdlib.system.io.Stream.Open( path,"r" )
