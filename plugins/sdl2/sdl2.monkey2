...
' iDkP:
'	I added a fork in the _new folder, adapted by Abakobo, but isn't used
'	because i saw a huge fps drops : https://github.com/abakobo/sdl2_9_mx2/issues/1
'	For now at least, undoned, back to the legacy version.
